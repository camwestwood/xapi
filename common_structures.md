...
The <b>description</b> describes the learning activity.<br/>
	   ...
	   The [object.extensions.http://xapi.jisc.ac.uk/event_type_id](/vocabulary.md#event-type-id) requires an identifier for the type of even<br/> [object.extensions.http://xapi.jisc.ac.uk/event_type_description](/vocabulary.md#event-type-description) is a description of the event type<br/>[object.extensions.http://xapi.jisc.ac.uk/event_max_count](/vocabulary.md#event-max-count)<br/> is the maximum number of people that could have attended the event. [object.extensions.http://xapi.jisc.ac.uk/event_mandatory](/vocabulary.md#event-mandatory) states if the event was optional or not <br/> <b>object.extensions.http://xapi.jisc.ac.uk/starttime</b> is the planned start time. Uses datetimes for planned end of event. <br/><b>object.extensions.http://xapi.jisc.ac.uk/endtime</b> The planned end time of event. Uses datetimes for planned end time of event.  <br/>
	    </td>  
	</tr>
 </table>
