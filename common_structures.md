...
<table>
	...
	<tr>
	   ...
	   The <b>description</b> describes the learning activity.<br/>
	   The <b>subType</b> may be used to qualify what kind of timetabled event occurred using an IRI given on the <a href="vocabulary.md#31-activity-types">vocabulary</a> page.
